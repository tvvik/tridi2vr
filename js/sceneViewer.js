var ViewerScene = function() {
	...
	this.initialise = function(container)
	{
        ...
        this.casa = new THREE.Object3D();

        var pereti = this.loadNewMesh('objects/casa/pereti.js', 'pereti');
        this.casa.add(pereti);
	...
	this.loadNewMesh = function(meshlink, meshname) 
	{
        ...
        loader.load(meshlink, function (geometry, materials){
            ...
            for (var i=0;i<mat.materials.length;i++)
            {
            	...
            	var newMat = new THREE.MeshStandardMaterial({map:tex});
            	mat.materials[i] = newMat;
            }
